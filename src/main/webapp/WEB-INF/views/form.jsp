            ...
            <div data-step="1" class="active">
                ...
                <div class="form-group form-group--checkbox">
                    ...
                    <div class="form-group form-group--buttons">
                        <button type="button" class="btn next-step" id="button-1">Dalej</button>
                    </div>
                </div>
            </div>
            ...
            <div data-step="4">
                ...
                <div class="form-section form-section--columns">
                    <div class="form-section--column">
                        <h4>Adres odbioru</h4>
                        <div class="form-group form-group--inline">
                            <label> Ulica <form:input path="street" id="loc"/> </label>
                        </div>

                        <div class="form-group form-group--inline">
                            <label> Miasto <form:input path="city" id="c"/> </label>
                        </div>
                        ...
                        <div class="form-group form-group--inline">
                            <label>
                                Numer telefonu <form:input path="phoneNumber" id="number"/>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <ul>
                            <li>
                                ...
                                <span class="summary--text" id="bag"></span>
                            </li>
